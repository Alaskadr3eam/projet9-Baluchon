...
struct Constant {
    ...
    static let apiKeyTranslate = "AIzaSyDX07xWgK_IQRN3wXHFBopwycC9AzachOU"

    // MARK: - properties moneyConvertEur
    static let moneyUrl = URL(string: "http://data.fixer.io/api/latest")!
    static let apiKeyMoney = "64c9be90700082a08ab21d1f2cef1132"

    // MARK: - properties moneyRecupArrayDevise
    static let deviseUrl = URL(string: "http://data.fixer.io/api/symbols")!
    static let apiKeyDevise = "64c9be90700082a08ab21d1f2cef1132"
    static var deviseSymbols = [DeviseSource]()
    static var deviseSymbolsEuro = [DeviseSource]()
    static let arrayDeviseSymbols = ["AED": "United Arab Emirates Dirham",
                                     "AFN": "Afghan Afghani",
                                     "ALL": "Albanian Lek",
                                     "AMD": "Armenian Dram",
